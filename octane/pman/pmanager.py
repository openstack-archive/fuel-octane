...
class PreseedPManager(object):
    def __init__(self, pm_data, keep_ceph_volumes=False):
        if isinstance(pm_data, (str, unicode)):
            self.pm_data = json.loads(pm_data)
        else:
            self.pm_data = pm_data
...
example = """
{
    ...
    "ks_spaces": [
        {
            "extra": [
                "disk/by-id/scsi-SAdaptec_t1_D0DD6729"
            ], 
            "free_space": 0, 
            "id": "disk/by-path/pci-0000:06:00.0-scsi-0:0:0:0", 
            "name": "sda", 
            "size": 11427840, 
            "type": "disk", 
            "volumes": [
        ...
        {
            "extra": [
                "disk/by-id/wwn-0x55cd2e404b62531b", 
                "disk/by-id/scsi-SATA_INTEL_SSDSC2BA2BTTV4173019P200GGN", 
                "disk/by-id/ata-INTEL_SSDSC2BA200G3_BTTV4173019P200GGN"
            ], 
            "free_space": 0, 
            "id": "sdb", 
            "name": "sdb", 
        ...
        {
            "extra": [
                "disk/by-id/wwn-0x55cd2e404b6255eb", 
                "disk/by-id/scsi-SATA_INTEL_SSDSC2BA2BTTV417301YU200GGN", 
                "disk/by-id/ata-INTEL_SSDSC2BA200G3_BTTV417301YU200GGN"
            ], 
            "free_space": 0, 
