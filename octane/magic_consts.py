...
COMPUTE_PREUPGRADE_PACKAGES = {
    'liberty-8.0': [
        ...
        "python-contextlib2", "python-oslo.serialization", "python-urllib3",
        "python-keystonemiddleware", "python-openssl", "fuel-ha-utils",
        "python-netaddr", "python-oslo.i18n", "python-cliff",
        "python-oslo.reports", "neutron-common", "python-oslo.versionedobjects",
        "python-oslo.db", "nailgun-mcagents", "python-novaclient",
        "python-unicodecsv", "neutron-plugin-openvswitch-agent",
        "python-oslo.rootwrap", "python-oslo.utils", "python-ipaddress",
        "python-oslo.lo", "python-msgpack", "python-amqp",
        "python-cryptography", "python-six", "python-oslo.context",
        "python-openvswitch", "python-netifaces", "network-checker",
        "python-oslo.messaging", "mcollective-common",
        "python-oslo.middleware", "python-jsonschema", "python-keystoneclient",
        "python-oslo.service", "python-neutronclient", "python-requests",
        "python-singledispatch", "python-neutron", "python-stevedore",
        "python-sqlalchemy", "nova-compute", "nova-compute-qemu",
        "python-extras", "mcollective", "python-cinderclient",
