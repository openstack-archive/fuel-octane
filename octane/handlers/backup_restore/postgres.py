...
class PostgresArchivator(base.CmdArchivator):
    ...
    def restore(self):
        ...
        systemd.set_systemctl_start_timeout(magic_consts.DOCKER_TIMEOUT)
        systemd.stop_service(self.db)
        ...
        systemd.start_service(self.db)
        systemd.unset_systemctl_start_timeout()
        self.sync_db()
