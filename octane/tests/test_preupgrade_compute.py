...
@pytest.mark.parametrize("version,ip,repos,repos_with_replace_uri", [
    ("liberty-8.0", "10.20.0.2", REPOS, REPOS_WITH_REPLACE_URI)
])
def test_get_repos(version, ip, repos, repos_with_replace_uri):
    release = mock.Mock()
    release.data = {}
    release.data['attributes_metadata'] = {}
    release.data['attributes_metadata']['editable'] = {}
    release.data['attributes_metadata']['editable']['repo_setup'] = {}
    release.data['attributes_metadata']['editable']['repo_setup']['repos'] = {}
    (release.data['attributes_metadata']['editable']['repo_setup']
     ['repos']['value']) = repos
