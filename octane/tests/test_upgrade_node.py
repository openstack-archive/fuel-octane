...
SKIPPED_TASKS = [
    [['task_1', 'task_2'], ['task_2', 'task_3'], ['task_4']],
    [],
]

UNIQUE_SKIPPED_TASKS = [
    ['task_1', 'task_2', 'task_3', 'task_4'],
    [],
]


@pytest.mark.parametrize('tasks,unique_tasks',
                         zip(SKIPPED_TASKS, UNIQUE_SKIPPED_TASKS))
def test_get_unique_skipped_tasks(tasks, unique_tasks):
    result = upgrade_node.get_unique_skipped_tasks(tasks)
    assert sorted(result) == unique_tasks
