    ...
    for service in services_list:
        while True:
            try:
                ...
                break
    status_bool = True if status == 'start' else False
    wait_for_corosync_services_sync(env, services_list, status_bool)
...
def start_cluster(env):
    ...
    wait_for_corosync_services_sync(env, services_list, status=True)
