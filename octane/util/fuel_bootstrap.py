...
# Ignore images not manageable by fuel-bootstrap
BOOTSTRAP_BLACKLIST_LIST = ['centos']
...
def get_not_active_images_uuids():
    ...
    return [img["uuid"] for img in images
            if img["status"] != "active" and
            img["uuid"] not in BOOTSTRAP_BLACKLIST_LIST]
