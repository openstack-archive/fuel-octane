...
mkdir -p ${RPM_BUILD_ROOT}/var/www/nailgun/octane/puppet
cp -vr %{_builddir}/%{name}-%{version}/octane/deployment/puppet/octane_tasks ${RPM_BUILD_ROOT}/var/www/nailgun/octane/puppet/octane_tasks
