...
cp -vr %{_builddir}/%{name}-%{version}/octane/patches ${RPM_BUILD_ROOT}/%{python2_sitelib}/octane/ && echo ${RPM_BUILD_ROOT}/%{python2_sitelib}/octane/patches >> %{_builddir}/%{name}-%{version}/INSTALLED_FILES
